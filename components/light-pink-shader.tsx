...
export default function LightPinkShader({
  ...
  useEffect(() => {
    ...
    console.log("Initializing Light Pink WebGL shader") // Added debug logging

    // Initialize WebGL2 context
    const gl = canvas.getContext("webgl2", { alpha: false, antialias: true })
    if (!gl) {
      console.error("WebGL2 not supported for light pink shader") // Enhanced error logging
      return
    }
    glRef.current = gl
    ...
    console.log("Starting light pink animation loop") // Added debug logging
